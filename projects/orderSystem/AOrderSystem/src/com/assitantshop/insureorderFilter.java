...
/**
 * Servlet Filter implementation class insureorderFilter
 */
@WebFilter("/insureorderFilter")
public class insureorderFilter implements Filter {

    /**
     * Default constructor. 
     */
    public insureorderFilter() {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException {
		...
		// place your code here
		  ...
		  List<orderclass> fy=f.getorderdetail(username, pagenostr, pagesizestr);
		  
		  
		  
		  int count=f.getsize(username);   //这里是得到数据的多少
