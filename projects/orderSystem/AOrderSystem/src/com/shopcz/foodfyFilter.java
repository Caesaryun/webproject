...
/**
 * Servlet Filter implementation class foodfyFilter
 */
@WebFilter("/foodfyFilter")
public class foodfyFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException {
		...
		// place your code here
		 ...
		 session.setAttribute("username",username);
		  ...
		  pl.setcount(count);
		 System.out.println("this is a filter"+count);
		  if(count%pagesize!=0) {
		   ...
		   String pd=(String)session.getAttribute("abc");
		   System.out.println("pd::"+pd);
		  
	       // pagemodel px = (pagemodel) ((HttpServletRequest)req).getSession().getAttribute("pageresult");
			
		   //((HttpServletRequest)req).getSession().setAttribute("pageresult",px);         
