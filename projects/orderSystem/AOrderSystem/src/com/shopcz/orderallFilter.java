...
/**
 * Servlet Filter implementation class orderallFilter
 */
@WebFilter("/orderallFilter")
public class orderallFilter implements Filter {

    /**
     * Default constructor. 
     */
    public orderallFilter() {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException {
		...
		// place your code here
		 int pageno=1; 
		  ...
		  List<orderclass> fy=sz.getallorderdetail(username, pagenostr, pagesizestr);
		  
		  
		  int count=sz.getallorderdsize(username);  //这里是得到数据的多少
