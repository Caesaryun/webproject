...
function checkthing(){
     ...
     document.form3.action="registerff";   //直接提交给该servlet
...
<body >
<!-- 输入用户名，然后邮箱，手机号得到手机号获取验证码 填写验证码，之后创建密码 -->
...
<br>
<a href=""><font  style="position:absolute;left:226px;width:240px;height:25px;" color="#ff6600" >《太白珍馐居网用户协议》</font></a><br>
