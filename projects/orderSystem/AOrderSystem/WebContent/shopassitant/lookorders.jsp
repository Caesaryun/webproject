...
function changeaccept(orderid,acceptid)
{
	 ...
	 window.location.href=encodeURI("http://localhost:8080/AOrderSystem/assitantchange?orderid="+orderid+"&acceptid="+acceptid.value);   //直接提交给该servlet
}
...
<div style="position:absolute;top:100px;width:1100px;left:208px;height:500px;background-color: rgba(255, 255, 240, 0.4);
        ...
        <font size="4">
          ...
          %>
        	  ...
        	  <a href="http://localhost:8080/AOrderSystem/orderfy?pageno=<%=i %>">第<%=i %>页</a>  
              <% } %>
              <br>
               总共<%=count %>页</font>   
          </div>
