...
<div style="position:absolute;top:0px;width:100%;height:10px;left:0px; background-color:	;
       ...
       <li><a style="position:absolute;top:4.3px;left:230px;color:#000000" href="changehotel.jsp">商家信息</a></li>
       ...
       <img style="position:absolute;width:17.5px;height:17.5px;right:100px;top:1.9px;" src ="img/头像.jpg" />
         ...
         <a href="changehotel.jsp">商家信息</a>

         <a href="changehotel.jsp">我的商店地址</a>
...
<div style="position:absolute;top:35px;width:100%;height:59px;left:0px; background-color:#FFA042;
         ...
         <ul class="list">
                    ...
                    <a href="addfood.jsp">添加菜单</a>
                    <a href="lookfood.jsp">修改菜单</a>
                    <a href="allorders.jsp">查看订单</a>
                    <a href="foodsales.jsp">查看销量</a>
                    <a >其他</a>                    
                  </div>
                    </a></li>
                    <li><a ><b>消息</b>
...
<span style="font-size:18px;">
	<div class="menu">
		<ul class="menubar">
			<li class="menu-value">
		    <li ><a href="changehotel.jsp"><font color="#000000">全部功能</font></a> </li><br>
		   
			<li ><a ><font >店铺订单</font></a></li>
			<li><a href="insureorder.jsp"><font size="2" color="#000000">新订单</font></a></li>
			<li><a href="allorders.jsp"><font size="2" color="#000000">近三个月订单</font></a></li>
			<br>
			
			<li>商店销售情况</li>
			<li><a href="foodsales.jsp"><font size="2" color="#000000">销量排行</font></a></li>
			<li><a ><font size="2" color="#000000">利润</font></a></li>
		   <br>
		   <li>店铺管理</li>
		   ...
		   <li><a href="lookfood.jsp"><font color="#000000" size="2">菜品修改</font></a></li>
